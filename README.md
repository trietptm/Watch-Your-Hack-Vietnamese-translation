...
Các nội dung trong bài viết chiếm khoảng 20-30% nội dung của khóa huấn luyện của tôi thực hành chi tiết hơn về bảo mật cho tài khoản cá nhân dành cho người nổi tiếng, các nhà hoạt động xã hội và những người giữ vị trí quan trọng trong các công ty.
...
* Chú ý vào việc **sử dụng ngôn ngữ lạ hoặc không chuẩn xác**. Nhiều email lừa đảo chưa các lỗi văn phạm hay lỗi chính tả và chúng có bắt đầu thư một cách chung chung như <mark>Dear sir/madam</mark>. Hầu hết các tổ chức biết chúng ta là ai và sẽ gọi bạn bằng tên chính xác của bạn.
* 
