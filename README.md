...
* Chú ý vào việc **sử dụng ngôn ngữ lạ hoặc không chuẩn xác**. Nhiều email lừa đảo chưa các lỗi văn phạm hay lỗi chính tả và chúng có bắt đầu thư một cách chung chung như <code>Dear sir/madam</code>. Hầu hết các tổ chức biết chúng ta là ai và sẽ gọi bạn bằng tên chính xác của bạn.
* 
